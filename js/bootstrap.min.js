...
!function(a){
    ...
    a("html").on("click.dropdown.data-api touchstart.dropdown.data-api",d),a("body").on("click.dropdown.data-api touchstart.dropdown.data-api",".dropdown form",function(a){
        a.stopPropagation()
